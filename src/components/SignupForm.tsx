...
export default function SignupForm() {
    ...
    return (
        <form onSubmit={onSubmit} action="/post" method="POST" className="form form--lg">
            ...
            <div className="form__block">
                계정이 있으신가요? <Link to="/login" className="form__link">로그인하기</Link>
            </div>
            <div className="form__block">
                <input type="submit" value="제출" className="form__btn--submit" disabled={error?.length > 0}></input>
            </div>
        </form>
    )
}